...
## Project Structure
    ...
    ├── throbbing_recipe_de_87484  # Django project configurations
...
1. Clone this repo and `cd throbbing_recipe_de_87484`
...
2. Clone this repo and `cd throbbing_recipe_de_87484`
